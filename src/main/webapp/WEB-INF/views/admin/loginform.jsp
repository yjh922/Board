...
<script type="text/javascript">
	...
	$(function() {
		...
		$("#findId").click(function() {
			location.href="/admin/findidform";
		});
		$("#findPass").click(function() {
			location.href="/admin/findpassform";
		});
...
<body>
	...
	<div class="bottom-container">
		<div class="row">
			<div class="col">
				<a href="#" style="color: white" class="btn" id="regist">회원가입</a>
			</div>
			<div class="col">
				<a href="#" style="color: white" class="btn" id="findId">아이디 찾기</a>
			</div>
			<div class="col">
				<a href="#" style="color: white" class="btn" id="findPass">비밀번호 찾기</a>
			</div>
		</div>
	</div>
